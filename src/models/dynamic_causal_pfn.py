...
class DynamicCausalPFN(TimeVaryingCausalModel):
    ...
    def __init__(self, args: DictConfig,
        ...
        elif args.model.dynamic_causal_pfn.projection_horizon is not None:
            self.projection_horizon = args.model.dynamic_causal_pfn.projection_horizon
    ...
    def _init_specific(self, args: DictConfig):
        ...
        """
        try:
            sub_args = args.model.dynamic_causal_pfn

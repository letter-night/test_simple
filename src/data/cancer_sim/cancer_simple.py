...
if __name__ == "__main__":
    ...
    seq_length = 30  # about half a year
    window_size = 15
    lag = 0  # lag of treatment assignment
    num_patients = 100
    radio_coeff = 10.0

    params = generate_params(num_patients, radio_coeff=radio_coeff, lag=lag, window_size=window_size)
    training_data = simulate_factual(params, seq_length)

    params = generate_params(int(num_patients / 10), radio_coeff=radio_coeff, lag=lag, window_size=window_size)

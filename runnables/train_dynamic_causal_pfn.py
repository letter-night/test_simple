...
def main(args: DictConfig):
    ...
    dataset_collection.process_data_pretrain() # prepare data set
    ...
    pfn_model = instantiate(args.model.dynamic_causal_pfn, args, dataset_collection, _recursive_=False)  # initialize dynamic_causal_pfn
